...
export const ESTADOS_VENDEDOR: EstadoVendedor[] = ["Seguimiento", "Cierre", "No responde"];
...
// Tipos de persona
export const TIPOS_PERSONA: TipoPersona[] = ["Lead Alvas", "Lead Propio", "Referido", "Cliente"];
