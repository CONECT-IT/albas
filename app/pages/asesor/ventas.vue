...
<template>
  <div class="p-8">
    ...
    <div class="flex justify-between items-center mb-6">
      ...
      <!--Boton agregar lead-->
      <button
        class="px-4 py-2 rounded-full font-semibold transition-colors duration-150 shadow-md bg-white text-negro-primario border border-gray-200"
    ...
    <div v-if="currentTab === 'Leads'" class="bg-white p-4 rounded-xl shadow-xl overflow-x-auto">
      ...
      <div class="divide-y divide-gray-100">
        <div
          v-for="n in 7"
          :key="'lead-row-' + n"
          class="grid grid-cols-12 gap-x-4 py-3 px-4 text-sm text-gray-800 min-h-[50px] items-center"
        >
          <span></span>
    ...
    >
      <div
        class="grid grid-cols-10 gap-x-4 py-4 px-4 text-sm font-semibold text-gray-600 border-b border-gray-200"
      >
        <span>N°</span>
        <span class="col-span-2">Nombre Completo</span>
        <span>Celular</span>
    ...
    <CaptacionFormsNuevoLeadForm v-if="showModal" @close="showModal = false" @crear="guardarLead" />
  </div>
</template>
