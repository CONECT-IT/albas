...
const listaGastos = ref<any[]>([
  {
    ...
    concepto: "Ejemplo: Taxi para visita de propiedad",
    monto: "15.00",
    fecha: "2025-11-20",
  },
]);
...
<template>
  ...
  <div class="fixed inset-0 flex items-center justify-center z-40 pointer-events-none p-4">
    <div
      class="bg-white rounded-[24px] p-0 shadow-2xl w-full max-w-[900px] max-h-[90vh] overflow-hidden pointer-events-auto font-sans relative border border-gray-100 flex flex-col"
    >
      <!-- Header -->
      <div
      ...
      <div class="overflow-y-auto p-8 custom-scrollbar flex-grow">
            ...
            <div class="space-y-4">
              <div>
                ...
                <input
                  ...
                  class="w-full bg-[#E0E0E0] rounded-xl py-2.5 px-4 text-sm font-medium text-gray-800 focus:bg-white focus:outline-none focus:ring-2 focus:ring-black/10 border border-transparent transition-all shadow-inner"
                />
              </div>
              ...
              <div>
                ...
                <div class="relative">
                  <span
                    class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 font-bold text-xs"
                    >$</span
                  >
                  <input
                    v-model="form.monto"
                    type="number"
                    placeholder="0.00"
                    class="w-full bg-[#E0E0E0] rounded-xl py-2.5 pl-7 pr-4 text-sm font-medium text-gray-800 focus:bg-white focus:outline-none focus:ring-2 focus:ring-black/10 border border-transparent transition-all shadow-inner"
                  />
                </div>
              </div>
            </div>
              ...
              <div>
                ...
                <div class="relative">
                  <input
                    v-model="form.fecha"
                    type="date"
                    class="w-full bg-[#E0E0E0] rounded-xl py-2.5 pl-4 pr-10 text-sm font-medium text-gray-800 focus:bg-white focus:outline-none focus:ring-2 focus:ring-black/10 border border-transparent transition-all shadow-inner"
                  />
                  <div
        ...
        <div class="rounded-xl overflow-hidden border border-gray-200 shadow-md bg-white">
          <div
            class="grid grid-cols-[1.5fr_2fr_1fr_1fr_80px] bg-black text-white px-4 py-3 text-[11px] font-bold uppercase tracking-widest text-center items-center"
          >
          ...
          <div class="divide-y divide-gray-100 bg-white min-h-[100px]">
            ...
            >
              <span
                class="text-left font-bold text-gray-800 pl-2 text-xs bg-gray-100 px-2 py-1 rounded w-fit"
