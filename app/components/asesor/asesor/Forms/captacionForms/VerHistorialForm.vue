...
const gastos = [
  {
    ...
    propId: 1,
    fecha: "2025-11-10",
    concepto: "Publicidad en Facebook",
    categoria: "Marketing",
    monto: 4000,
  },
  {
...
const formatoMoneda = (monto) => {
  let valor = new Intl.NumberFormat("en-PE", {
    style: "currency",
    currency: "PEN",
...
<template>
  ...
  <div class="fixed inset-0 flex items-center justify-center z-50 pointer-events-none p-4">
    <div
      class="bg-white rounded-[30px] shadow-2xl w-full max-w-[800px] pointer-events-auto relative border border-gray-200 flex flex-col max-h-[95vh]"
    >
      ...
      <div class="p-8 pt-0 overflow-y-auto space-y-8 pb-10">
          ...
          <div class="bg-gradient-to-b from-gray-100 to-white p-6 flex gap-6">
            ...
            >
              ...
              <span class="text-2xl font-bold text-black">{{
                formatoMoneda(totalMontoGastos)
              }}</span>
        ...
        <div class="rounded-xl overflow-hidden border border-gray-200 shadow-sm">
          ...
          <div class="bg-gradient-to-b from-gray-50 to-white p-4">
            ...
            <div class="space-y-3">
              <div v-if="totalCitas === 0" class="text-center text-xs text-gray-400 py-4">
                Sin citas.
              </div>
              ...
              >
                <span class="text-xs font-bold text-black">{{
                  formatoFechaLarga(cita.fecha)
                }}</span>
                <span class="text-xs font-bold text-black">{{ cita.hora }}</span>
                <span
                  class="text-xs font-bold text-black text-right truncate"
        ...
        <div class="rounded-xl overflow-hidden border border-gray-200 shadow-sm">
          ...
          <div class="bg-gradient-to-b from-gray-50 to-white p-4">
            ...
            <div class="space-y-3">
              <div v-if="totalGastosCount === 0" class="text-center text-xs text-gray-400 py-4">
                Sin gastos.
              </div>
              ...
              >
                ...
                <span class="text-xs font-bold text-black text-right">{{
            ...
            <div
              v-if="totalGastosCount > 0"
              class="mt-6 pt-4 border-t border-gray-300 flex justify-end items-center gap-6"
            >
