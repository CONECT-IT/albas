...
<template>
  ...
  <div class="fixed inset-0 flex items-center justify-center z-50 pointer-events-none p-4">
    <div
      class="bg-blanco-primario rounded-[24px] w-full max-w-[900px] max-h-[90vh] shadow-2xl border border-gray-100 flex flex-col pointer-events-auto overflow-hidden"
    >
      <!-- HEADER -->
      ...
      <div class="overflow-y-auto p-8 custom-scrollbar flex-grow">
        ...
        <div class="mb-8">
          ...
          <select
            ...
            class="w-full max-w-sm bg-[#E0E0E0] rounded-xl py-3 px-4 text-sm font-bold shadow-inner"
          >
            ...
            <div class="space-y-4">
              <div>
                ...
                <input
                  ...
                  class="w-full bg-[#E0E0E0] rounded-xl py-2.5 px-4 shadow-inner"
                />
              </div>
              <div>
        ...
        <div class="rounded-xl overflow-hidden border border-gray-200 shadow-md bg-blanco-primario">
          <div
            class="grid grid-cols-[1.5fr_2fr_1fr_1fr_80px] bg-black text-blanco-primario px-4 py-3 text-[11px] font-bold uppercase tracking-widest text-center"
          >
          ...
          <div class="divide-y divide-gray-100 bg-blanco-primario min-h-[100px]">
            <div
              ...
              class="py-8 text-center text-gray-400 text-sm italic"
            >
      ...
      <div class="bg-gray-50 px-8 py-4 border-t flex justify-end gap-3">
        <button @click="$emit('close')" class="px-6 py-2 border rounded-xl">Cancelar</button>
        <button
          @click="guardarCambios"
          class="px-8 py-2 bg-negro-primario text-blanco-primario rounded-xl"
        >
          Guardar Cambios
        </button>
      </div>
