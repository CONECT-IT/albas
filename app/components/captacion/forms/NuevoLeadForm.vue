...
const emit = defineEmits<{
  close: [];
  crear: [data: { nombre: string; celular: string; tipo: TipoPersona }];
}>();
...
<template>
  ...
  >
    ...
    <template #footer>
      <UiBaseButton variant="secondary" @click="emit('close')"> Cancelar </UiBaseButton>
      <UiBaseButton @click="handleSubmit"> Crear Lead </UiBaseButton>
    </template>
  </UiBaseModal>
</template>
