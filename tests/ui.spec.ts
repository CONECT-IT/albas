...
test.describe('Theme Toggle', () => {
  ...
  test.skip('puede alternar modo oscuro en admin - alternador de tema no implementado aún', async ({ page }) => {
    ...
    const themeBtn = page.locator('.theme-toggle, button:has-text("Oscuro"), button:has-text("Claro")').first();
